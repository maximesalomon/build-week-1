...
const Process = () => {
    return (
      ...
      <div className="growth-levers">
        ...
        <div className="gl-right"><img src={coworkersright} height="300px" /></div>
      </div>
      <div className="growth-experiments">
        <div className="ge-left"><img src={coworkersleft} height="300px" /></div>
      ...
      <div className="design-build-analyse">
        ...
        <div className="dba-right"><img src={coworkersright} height="300px" /></div>
      </div>
      </section>
    )
};  
